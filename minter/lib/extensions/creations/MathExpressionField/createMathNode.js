...
import { SymbolNode, ConstantNode, FunctionNode, OperatorNode, AssignmentNode } from './MathNode.js';
/**
* Create the corresponding MathJS node of a Token and its children.
* @returns A newly constructed MathJS node.
*/
export function createMathNode(token, children = []) {
    ...
    switch (token.type) {
        ...
        case 3 /* TokenType.Plus */:
            return new OperatorNode((token.type == 3 /* TokenType.Plus */) ? '+' : '-', children);
        ...
        case 2 /* TokenType.Equals */:
            return new AssignmentNode(children[0], children[1]);
...
//# sourceMappingURL=createMathNode.js.map